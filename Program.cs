...
namespace FB.ColumnPresetsCopier
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var arc=new ColumnPresetsCopier(apiAddress,accessToken);
        ...
        {
            Console.WriteLine("Программа для скачивания/загрузки шаблонов отображения в Facebook by Даниил Выголов.");
            Console.WriteLine("Варианты запуска:");
            Console.WriteLine("Скачивание шаблонов отображения из рекламного кабинета с указанным ID:");
